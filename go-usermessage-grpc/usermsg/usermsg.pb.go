...
func (x *MessageMessageData) Reset() {
	*x = MessageMessageData{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageMessageData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageMessageData) ProtoMessage() {}

func (x *MessageMessageData) ProtoReflect() protoreflect.Message {
	mi := &file_usermsg_usermsg_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageMessageData.ProtoReflect.Descriptor instead.
func (*MessageMessageData) Descriptor() ([]byte, []int) {
	return file_usermsg_usermsg_proto_rawDescGZIP(), []int{1, 0}
}

func (x *MessageMessageData) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *MessageMessageData) GetData() string {
	if x != nil {
		return x.Data
	}
	return ""
...
type MessageMessageDataContent struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *MessageMessageDataContent) Reset() {
	*x = MessageMessageDataContent{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageMessageDataContent) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageMessageDataContent) ProtoMessage() {}

func (x *MessageMessageDataContent) ProtoReflect() protoreflect.Message {
	mi := &file_usermsg_usermsg_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageMessageDataContent.ProtoReflect.Descriptor instead.
func (*MessageMessageDataContent) Descriptor() ([]byte, []int) {
	return file_usermsg_usermsg_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
var file_usermsg_usermsg_proto_rawDesc = []byte{
	...
	,
}
...
var file_usermsg_usermsg_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_usermsg_usermsg_proto_goTypes = []interface{}{
	(*NewMessage)(nil),                   // 0: usermsg.NewMessage
	(*Message)(nil),                      // 1: usermsg.Message
	(*NewMessageMessageData)(nil),        // 2: usermsg.NewMessage.message_data
	(*NewMessageMessageDataContent)(nil), // 3: usermsg.NewMessage.message_data.content
	(*MessageMessageData)(nil),           // 4: usermsg.Message.message_data
	(*MessageMessageDataContent)(nil),    // 5: usermsg.Message.message_data.content
	(*timestamppb.Timestamp)(nil),        // 6: google.protobuf.Timestamp
}
var file_usermsg_usermsg_proto_depIdxs = []int32{
	6, // 0: usermsg.NewMessage.ts:type_name -> google.protobuf.Timestamp
	6, // 1: usermsg.Message.ts:type_name -> google.protobuf.Timestamp
	0, // 2: usermsg.UserMessage.CreateNewMessage:input_type -> usermsg.NewMessage
	1, // 3: usermsg.UserMessage.CreateNewMessage:output_type -> usermsg.Message
...
func file_usermsg_usermsg_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_usermsg_usermsg_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageMessageData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_usermsg_usermsg_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageMessageDataContent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
